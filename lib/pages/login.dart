...
// Get.back();
  ...
  Login() async {
    ...
    if (responsebody['status'] == "success") {
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: Text(
          "هاذ الحساب موجود بالفعل ساعدنا ب الوصول الية".toString(),
          textAlign: TextAlign.center,
          style:
          TextStyle(color: Colors.white, fontSize: 20, fontFamily: 'Cairo'),
        ),
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: Text(
          "هاذ الحساب غير موجود يرجى التأكد من رقم هاتفك والمعاودة مره اخرى".toString(),
          textAlign: TextAlign.center,
          style:
          TextStyle(color: Colors.white, fontSize: 20, fontFamily: 'Cairo'),
        ),
                      ...
                      child: Pinput(
                        ...
                        onCompleted: (pin) async {
                          ...
                          islogin = true;
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                              content: Text(
                                "رقم كود خاطئ حاول مرة اخرى".toString(),
                                textAlign: TextAlign.center,
                                style:
                                TextStyle(color: Colors.white, fontSize: 20, fontFamily: 'Cairo'),
                              ),
  ...
  verifyPhoneNumber() async {
    await FirebaseAuth.instance.verifyPhoneNumber(
        ...
        verificationFailed: (FirebaseAuthException e) {
          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
            content: Text(
              "قد يكون الرقم المدخل غير صحيح او مفتاح دولتك".toString(),
              textAlign: TextAlign.center,
              style:
              TextStyle(color: Colors.white, fontSize: 20, fontFamily: 'Cairo'),
            ),
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                "مضمون سيقوم بمساعدتك للوصول الى حسابك \n  هيا بنا ",
                                style: GoogleFonts.roboto(
                                    fontSize: 14,
          ...
          child: Directionality(
            ...
            child: Column(
              ...
              children: [
                ...
                buildTextField(
                    Icons.lock_outline, "كلمة السر الجديدة", true, true, password),
                buildTextField(Icons.lock_outline, "إعادة كلمة السر الجديدة", true,
